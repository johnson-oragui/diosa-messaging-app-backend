...
const RegisterForm = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const idempotency_key: string = CryptoJS.SHA256(input.email + input.username).toString();
            ...
            <div className="bg-gray-100 dark:bg-gray-900">
                <div className="w-full max-w-3xl mx-auto p-8">
                    <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md border dark:border-gray-700">
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Join the Biggest Chat-Room</h1>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label htmlFor="email" className="block text-gray-700 dark:text-white mb-1">
                                            Email
                                        </label>
                                        <input
                                            id="email"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label htmlFor="confirm_password" className="block text-gray-700 dark:text-white mb-1">
                                            Confirm Password
                                        </label>
                                        <input
                                            type="password"
