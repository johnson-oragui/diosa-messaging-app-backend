                ...
                <div className="">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                            ...
                            <div className="w-full  mb-4 lg:mt-6">
                                <label htmlFor="recovery_email" className=" dark:text-gray-300">Recovery Email</label>
                                <input
                                    type="text"
                                    id="recovery_email"
                                    name="recovery_email"
                                    value={input.recovery_email}
                                    onChange={handleInput}
                                    className="mt-2 p-4 w-full border-2 rounded-lg dark:text-gray-200 dark:border-gray-600 dark:bg-gray-800"
                            ...
                            <div className="w-full  mb-4 lg:mt-6">
                                <label htmlFor="profession" className=" dark:text-gray-300">Profession</label>
                                <input
                                    type="text"
                                    id="profession"
                                    name="profession"
                            ...
                            <div className="w-full  mb-4 lg:mt-6">
                                <label htmlFor="facebook_link" className=" dark:text-gray-300">Facebook Link</label>
                                <input
                                    type="text"
                                    id="facebook_link"
                                    name="facebook_link"
                            ...
                            <div className="w-full  mb-4 lg:mt-6">
                                <label htmlFor="instagram_link" className=" dark:text-gray-300">Instagram Link</label>
                                <input
                                    type="text"
                                    id="instagram_link"
                                    name="instagram_link"
                            ...
                            <div className="w-full  mb-4 lg:mt-6">
                                <label htmlFor="x_link" className=" dark:text-gray-300">X Link</label>
                                <input
                                    type="text"
                                    id="x_link"
                                    name="x_link"
                        ...
                        <div className="w-full mb-4 mt-4">
                                <label htmlFor="gender" className="mb-2 dark:text-gray-300">Gender</label>
                                <select
                                    id="gender"
                                    name="gender"
                                    value={input.gender}
